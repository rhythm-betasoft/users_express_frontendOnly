<template>
  ...
  <v-container>
    <DxDataGrid
      :data-source="LeaveData.dataSource"
      :remote-operations="{ filtering: true, sorting: true, paging: true }"
      :show-borders="true"
      :column-auto-width="true"
      :row-alternation-enabled="true"   
      :filter-row="{ visible: true, showOperationChooser: true }" ref="leavedataref"
      :paging="LeaveData.pagingOption"
    ...
    <DxColumn data-field="startDate" alignment="center" caption="Start Date" data-type="date" :hiding-priority="5" format="dd-MM-yyyy" />
    <DxColumn data-field="endDate" alignment="center" caption="End Date" data-type="date" :hiding-priority="6" format="dd-MM-yyyy" />
